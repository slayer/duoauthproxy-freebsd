...
class MyService(win32serviceutil.ServiceFramework):
        ...
        try:
            ...
            if return_code != 0:
                ...
                message = "Your configuration is not valid. Check the output " \
                          "at {conn_tool_logs} for errors.".format(conn_tool_logs=self.conn_tool_logs)
            ...
            win32evtlogutil.ReportEvent(
                ...
                (self._svc_name_,
                 ...
                 'After fixing the errors you can run a test of your configuration using our validator located at %s' % (message, self.conn_tool_logs, self.conn_tool_path)))
        else:
    ...
    def run_connectivity_tool(self):
        ...
        try:
            return subprocess.call([conn_tool, '--no-explicit-connectivity-check', '--startup'])
        except OSError as e:
