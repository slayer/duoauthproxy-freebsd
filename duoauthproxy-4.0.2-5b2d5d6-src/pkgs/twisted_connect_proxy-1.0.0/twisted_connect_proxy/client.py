...
class HTTPProxyConnector(object):
    ...
    def callLater(self, delay, c, *args, **kw):
        return self.reactor.callLater(delay, c, *args, **kw)

    def cancelCallLater(self, callID):
        return self.reactor.cancelCallLater(callID)

    def getDelayedCalls(self):
        return self.reactor.getDelayedCalls()
...
if __name__ == '__main__':
    ...
    d = agent.request(b'GET', b'https://www.google.com/robots.txt')
    d.addCallback(cb)
