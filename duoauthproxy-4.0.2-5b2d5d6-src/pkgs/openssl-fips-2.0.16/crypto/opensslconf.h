...
#define ENGINESDIR "/root/duoauthproxy-4.0.2-5b2d5d6-src/pkgs/openssl-fips-2.0.16/dist/lib/engines"
#define OPENSSLDIR "/root/duoauthproxy-4.0.2-5b2d5d6-src/pkgs/openssl-fips-2.0.16/dist"
#endif
#endif
