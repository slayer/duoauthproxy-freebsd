...
class Client(host.Host):
    ...
    def __init__(self, server, authport=1812, acctport=1813,
        ...
        self.retries = 3
        self.timeout = 5
        # BEGIN DUO EDIT @iraja: select.poll is not support by Windows
        # These DUO EDITs revent to using select.select instead
        # See: https://github.com/pyradius/pyrad/commit/89cc29cfb44079691e073c43da58c8499400bb9c
        #
