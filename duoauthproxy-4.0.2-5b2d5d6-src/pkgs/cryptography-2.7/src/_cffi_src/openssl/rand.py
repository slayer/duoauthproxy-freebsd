...
# DUO EDIT @mbishop
# Add in RAND_load_file binding since we need to call this function properly reseed the random
# number generator on forking
FUNCTIONS = FUNCTIONS + "int RAND_load_file(const char *, long);"
# END DUO EDIT
