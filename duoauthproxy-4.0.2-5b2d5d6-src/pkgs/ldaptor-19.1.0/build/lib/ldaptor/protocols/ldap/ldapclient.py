...
class LDAPClient(protocol.Protocol):
    ...
    def send(self, op, controls=None, handler=None, handle_msg=False):
        ...
        @param handle_msg: If true, the handler will be called with
        the LDAPMessage object instead of the message's
        protocolOp/value.
        ...
        if handler is not None:
            self.onwire[msg.id] = (d, handle_msg, handler, [], {})
        else:
            self.onwire[msg.id] = (d, handle_msg, None, None, None)
