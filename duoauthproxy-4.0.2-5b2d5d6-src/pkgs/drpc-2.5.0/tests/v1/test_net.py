...
class TestWireFormat(DrpcTestBase):
    ...
    def connect(self, factory_class):
        factory = factory_class(self.ikey, self.skey)
    ...
    def msg_byte_seqs(self, data_bytes,
        ...
        sig_bytes = json.dumps({
            'sig': drpc.net.hmac_sha256(self.skey, data_bytes, sig_time),
            'time': sig_time,
        }).encode('utf8')
        return [
    ...
    def test_protocol(self):
        ...
        self.assertEqual(protocol.TYPE_JSON,
    ...
    def test_drpc_hmac_sha256(self):
        self.assertEqual('75c4bc6b40ed96f83e302c36d38f57cc5f624248eba5f2e8c9ecade92d569e3f',
                         drpc.net.hmac_sha256(b'foo', b'b\x0Ar' * 100, 4593))
    ...
    def test_send_msg_time_offset(self):
        ...
        for time_offset in (500, -500):
            ...
            data_bytes = b'\x00\x00\x00\x0e\x00"abc"'
    ...
    def test_sig_bad_time(self):
        ...
        now = int(time.time())
        delta = protocol.SIG_WINDOW + 1
        for t in (now - delta,
                  now + delta):
            sig = {
                'sig': drpc.net.hmac_sha256(self.skey, data_bytes, t),
                'time': t,
            }
    ...
    def test_msg_bad_data_json(self):
        ...
        sig_time = int(time.time())
        sig_bytes = json.dumps({
            'sig': drpc.net.hmac_sha256(self.skey,
...
class TestFeatures(DrpcTestBase):
    ...
    def setUp(self):
        ...
        self.server_factory = self.ServerFactory(self.ikey, self.skey)
    ...
    def connect_client(self):
        ...
        client_factory = drpc.ClientFactory(self.ikey, self.skey)
