...
build_time_vars = {'ABIFLAGS': '',
 ...
 'CFLAGS': '-Wno-unused-result -Wsign-compare -DNDEBUG '
           '-I/root/duoauthproxy-4.0.2-5b2d5d6-src/pkgs/Python-3.8.4/../../duoauthproxy-build/usr/local/openssl/include '
 ...
 'CONFIGFILES': 'configure configure.ac acconfig.h pyconfig.h.in '
                'Makefile.pre.in',
 'CONFIGURE_CFLAGS': '-I/root/duoauthproxy-4.0.2-5b2d5d6-src/pkgs/Python-3.8.4/../../duoauthproxy-build/usr/local/openssl/include '
                     '-O2 -Wall -fstack-protector --param=ssp-buffer-size=4 '
                     '-D_FORTIFY_SOURCE=2 -fomit-frame-pointer -fPIC',
 ...
 'CONFIG_ARGS': "'--with-threads' '--enable-unicode=ucs4' '--with-system-ffi' "
                "'--with-openssl=/root/duoauthproxy-4.0.2-5b2d5d6-src/duoauthproxy-build/usr/local/openssl' "
                "'--without-ensurepip' "
                "'CFLAGS=-I/root/duoauthproxy-4.0.2-5b2d5d6-src/pkgs/Python-3.8.4/../../duoauthproxy-build/usr/local/openssl/include "
                '-O2 -Wall -fstack-protector --param=ssp-buffer-size=4 '
                "-D_FORTIFY_SOURCE=2 -fomit-frame-pointer -fPIC' "
 ...
 'COREPYTHONPATH': '',
 'COVERAGE_INFO': '/root/duoauthproxy-4.0.2-5b2d5d6-src/pkgs/Python-3.8.4/coverage.info',
 'COVERAGE_REPORT': '/root/duoauthproxy-4.0.2-5b2d5d6-src/pkgs/Python-3.8.4/lcov-report',
 ...
 'OBJECT_OBJS': '\\',
 'OPENSSL_INCLUDES': '-I/root/duoauthproxy-4.0.2-5b2d5d6-src/duoauthproxy-build/usr/local/openssl/include',
 'OPENSSL_LDFLAGS': '-L/root/duoauthproxy-4.0.2-5b2d5d6-src/duoauthproxy-build/usr/local/openssl/lib',
 ...
 'abs_builddir': '/root/duoauthproxy-4.0.2-5b2d5d6-src/pkgs/Python-3.8.4',
 'abs_srcdir': '/root/duoauthproxy-4.0.2-5b2d5d6-src/pkgs/Python-3.8.4',
