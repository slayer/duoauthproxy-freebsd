...
from duoauthproxy.lib import util, ip_util
...
from duoauthproxy.lib.validation.connectivity.connectivity_results import RadiusClientResult, ConfigCheckResult, MissingConfigKeyProblem, InvalidConfigKeyProblem
...
def _connect_radius(host, port, config, toolbox):
    ...
    client = Client(server=host, authport=port, secret=secret, dict=base.radius_dictionary())
