...
def ldap_search_has_results(bound_client, search_dn_str, filter_object):
    ...
    try:
        search_results = yield bound_client.perform_search(search_dn, filter_object, sizeLimit=1)
...
def can_bind_service_account(client, keep_bound=False):
    ...
    try:
        ...
        result = LdapBindResult(False, client.factory.service_account_username, exception=e)
