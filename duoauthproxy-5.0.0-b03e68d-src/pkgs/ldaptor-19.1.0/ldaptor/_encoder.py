...
def repr_converter(value):
    ...
    * Unicode string for Python 3
    ...
    # XXX DUO EDIT
    # XXX Some things that are BEROctetStrings, like serverSaslCreds or cookies
    # XXX for paged searches, contain binary data so they can't be utf-8 decoded
    # XXX like to_unicode attempts to do. If an exception occurs, just return
    # XXX the passed in value as-is. No alteration of the value's repr will
    # XXX occur in that case.
    #
