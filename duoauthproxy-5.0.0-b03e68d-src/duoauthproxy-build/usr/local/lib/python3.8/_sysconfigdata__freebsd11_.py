...
build_time_vars = {'ABIFLAGS': '',
 ...
 'BLDSHARED': 'gcc -pthread -shared -Wl,-z,relro -Wl,-z,now '
              "-Wl,-rpath='$ORIGIN/../openssl/lib'",
 'BUILDEXE': '',
 'BUILDPYTHON': 'python',
 'BUILD_GNU_TYPE': 'x86_64-unknown-freebsd11.2',
 'BYTESTR_DEPS': '\\',
 'CC': 'gcc -pthread',
 'CCSHARED': '-fPIC',
 'CFLAGS': '-Wno-unused-result -Wsign-compare -DNDEBUG '
           '-I/root/duoauthproxy-5.0.0-b03e68d-src/pkgs/Python-3.8.4/../../duoauthproxy-build/usr/local/openssl/include '
           '-O2 -Wall -fstack-protector --param=ssp-buffer-size=4 '
           '-D_FORTIFY_SOURCE=2 -fomit-frame-pointer -fPIC',
 'CFLAGSFORSHARED': '',
 'CFLAGS_ALIASING': '',
 'CFLAGS_NODIST': '',
 'CONFIGFILES': 'configure configure.ac acconfig.h pyconfig.h.in '
                'Makefile.pre.in',
 'CONFIGURE_CFLAGS': '-I/root/duoauthproxy-5.0.0-b03e68d-src/pkgs/Python-3.8.4/../../duoauthproxy-build/usr/local/openssl/include '
                     '-O2 -Wall -fstack-protector --param=ssp-buffer-size=4 '
                     '-D_FORTIFY_SOURCE=2 -fomit-frame-pointer -fPIC',
 ...
 'CONFIGURE_CPPFLAGS': '',
 'CONFIGURE_LDFLAGS': '-Wl,-z,relro -Wl,-z,now '
                      "-Wl,-rpath='$ORIGIN/../openssl/lib'",
 'CONFIGURE_LDFLAGS_NODIST': '',
 'CONFIG_ARGS': "'--with-threads' '--enable-unicode=ucs4' '--with-system-ffi' "
                "'--with-openssl=/root/duoauthproxy-5.0.0-b03e68d-src/duoauthproxy-build/usr/local/openssl' "
                "'--without-ensurepip' "
                "'CFLAGS=-I/root/duoauthproxy-5.0.0-b03e68d-src/pkgs/Python-3.8.4/../../duoauthproxy-build/usr/local/openssl/include "
                '-O2 -Wall -fstack-protector --param=ssp-buffer-size=4 '
                "-D_FORTIFY_SOURCE=2 -fomit-frame-pointer -fPIC' "
 ...
 'COREPYTHONPATH': '',
 'COVERAGE_INFO': '/root/duoauthproxy-5.0.0-b03e68d-src/pkgs/Python-3.8.4/coverage.info',
 'COVERAGE_REPORT': '/root/duoauthproxy-5.0.0-b03e68d-src/pkgs/Python-3.8.4/lcov-report',
 ...
 'HAVE_ZLIB_COPY': 1,
 'HAVE__GETPTY': 0,
 'HOST_GNU_TYPE': 'x86_64-unknown-freebsd11.2',
 ...
 'LDLIBRARYDIR': '',
 'LDSHARED': 'gcc -pthread -shared -Wl,-z,relro -Wl,-z,now '
             "-Wl,-rpath='$ORIGIN/../openssl/lib'",
 'LDVERSION': '3.8',
 'LIBC': '',
 ...
 'LIBS': '-lcrypt -lintl -ldl  -lutil -lm',
 ...
 'LN': 'ln',
 'LOCALMODLIBS': '-L../../duoauthproxy-build/usr/local/openssl/lib -lssl '
                 '-lcrypto',
 'MACHDEP': 'freebsd11',
 'MACHDEP_OBJS': '',
 ...
 'MODDISABLED_NAMES': '',
 'MODLIBS': '-L../../duoauthproxy-build/usr/local/openssl/lib -lssl -lcrypto',
 ...
 'OBJECT_OBJS': '\\',
 'OPENSSL_INCLUDES': '-I/root/duoauthproxy-5.0.0-b03e68d-src/duoauthproxy-build/usr/local/openssl/include',
 'OPENSSL_LDFLAGS': '-L/root/duoauthproxy-5.0.0-b03e68d-src/duoauthproxy-build/usr/local/openssl/lib',
 ...
 'PY_BUILTIN_MODULE_CFLAGS': '-Wno-unused-result -Wsign-compare -DNDEBUG '
                             '-I/root/duoauthproxy-5.0.0-b03e68d-src/pkgs/Python-3.8.4/../../duoauthproxy-build/usr/local/openssl/include '
                             '-O2 -Wall -fstack-protector '
                             '--param=ssp-buffer-size=4 -D_FORTIFY_SOURCE=2 '
                             '-fomit-frame-pointer -fPIC -std=c99 -Wextra '
                             '-Wno-unused-result -Wno-unused-parameter '
                             '-Wno-missing-field-initializers '
                             '-Werror=implicit-function-declaration  '
                             '-I./Include/internal -I. -I./Include '
                             '-DPy_BUILD_CORE_BUILTIN',
 'PY_CFLAGS': '-Wno-unused-result -Wsign-compare -DNDEBUG '
              '-I/root/duoauthproxy-5.0.0-b03e68d-src/pkgs/Python-3.8.4/../../duoauthproxy-build/usr/local/openssl/include '
              '-O2 -Wall -fstack-protector --param=ssp-buffer-size=4 '
              '-D_FORTIFY_SOURCE=2 -fomit-frame-pointer -fPIC',
 ...
 'PY_CORE_CFLAGS': '-Wno-unused-result -Wsign-compare -DNDEBUG '
                   '-I/root/duoauthproxy-5.0.0-b03e68d-src/pkgs/Python-3.8.4/../../duoauthproxy-build/usr/local/openssl/include '
                   '-O2 -Wall -fstack-protector --param=ssp-buffer-size=4 '
                   '-D_FORTIFY_SOURCE=2 -fomit-frame-pointer -fPIC -std=c99 '
                   '-Wextra -Wno-unused-result -Wno-unused-parameter '
                   '-Wno-missing-field-initializers '
                   '-Werror=implicit-function-declaration  '
                   '-I./Include/internal -I. -I./Include -DPy_BUILD_CORE',
 'PY_CORE_LDFLAGS': '-Wl,-z,relro -Wl,-z,now '
                    "-Wl,-rpath='$ORIGIN/../openssl/lib'",
 'PY_CPPFLAGS': '-I. -I./Include',
 'PY_FORMAT_SIZE_T': '"z"',
 'PY_LDFLAGS': "-Wl,-z,relro -Wl,-z,now -Wl,-rpath='$ORIGIN/../openssl/lib'",
 'PY_LDFLAGS_NODIST': '',
 ...
 'SGI_ABI': '@SGI_ABI@',
 'SHELL': '/bin/sh',
 'SHLIBS': '-lcrypt -lintl -ldl  -lutil -lm',
 'SHLIB_SUFFIX': '.so',
 'SHM_NEEDS_LIBRT': 0,
 ...
 'SSL': '../../duoauthproxy-build/usr/local/openssl',
 'STDC_HEADERS': 1,
 ...
 'abs_builddir': '/root/duoauthproxy-5.0.0-b03e68d-src/pkgs/Python-3.8.4',
 'abs_srcdir': '/root/duoauthproxy-5.0.0-b03e68d-src/pkgs/Python-3.8.4',
